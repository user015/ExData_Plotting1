...
par(mfrow=c(2,2))
plot(timestamp,dt$Global_active_power,type="l",ylab="Global Active Power (kilowatts) ",xlab="")
plot(timestamp,dt$Voltage,type="l",ylab="Voltage",xlab="datetime")
plot(timestamp,dt$Sub_metering_1,col="Black",type="n",ylab="Energy sub metering",xlab="")
lines(timestamp,dt$Sub_metering_2,col="Red")
lines(timestamp,dt$Sub_metering_3,col="Blue")
lines(timestamp,dt$Sub_metering_1,col="Black")
plot(timestamp,dt$Global_reactive_power,type="l",ylab="Global_reactive_power",xlab="datetime")
dev.off()